...
import { List as NativeBaseList, ListItem, Text, Icon, Left, Body, Right, Badge } from 'native-base'
...
const List = ({ countries, countryNames, navigateToCountry }) => (
  <ErrorBoundary>
    <NativeBaseList>
      {countries.map((country) => {
        ...
        return (
          <ListItem
            key={country.Country}
            onPress={() => {
              navigateToCountry(country.Country, currentCountry.code)
            }}
          >
            <Left>
