...
import { Header, Picker, Icon, Item, Input } from 'native-base'
import DefaultHeader from 'components/DefaultHeader/DefaultHeader'

const HeaderPresentational = ({ searchQuery, sortingOption, onSearchChange, onSortingChange }) => (
  <ErrorBoundary>
    <DefaultHeader title="Countries" />
    <Header searchBar rounded>
      <Picker mode="dropdown" onValueChange={onSortingChange} iosHeader="Order by" iosIcon={<Icon name="arrow-down" />} selectedValue={sortingOption}>
