...
const Country = () => {
  ...
  const [fetchFavoritesDispatch, addToFavoritesDispatch, removeFromFavoritesDispatch, setCountryDispatch, fetchCountryDispatch] = useActions([
    fetchFavorites,
    addToFavorites,
    removeFromFavorites,
    setCountry,
  ...
  const { favorites, country } = useSelector(
    (state) => ({
  ...
  return (
    <Container
      ...
      tabs={<Tabs data={country} onTabChange={onTabChange} />}
    />
  )
}
